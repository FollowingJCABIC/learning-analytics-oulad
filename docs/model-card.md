# Model card: weekly next-assessment forecasting
...
The project evaluates analytical quality and portability across presentations.
...
On the complete 2014J held-out set of 117,186 weekly snapshots, the boosted
...
The calibrated logistic model is the recommended interpretable reference. It
...
Executed metrics are saved in `reports/tables/model_metrics.csv`; calibration,
...
days. On held-out 2014J snapshots, prevalence was 3.9%, PR AUC was 0.082,
